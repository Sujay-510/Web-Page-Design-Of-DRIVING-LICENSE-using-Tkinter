...
window = Tk()
window.title('Know Your Driving License Status')
window.geometry("1300x770")


canvas = Canvas(relief = RIDGE  , background = 'blue' ,height=50 , width=1300)
canvas.place(x = 0 , y = 0)
btn1 = Button(window, text='Home', width=5,
             height=1, bg= 'blue',fg = 'white', command=window.destroy , activebackground = 'black' , font = ('Helvetica',12))
...
photo1 = PhotoImage(file = r"C:\Users\DELL\PycharmProjects\pythonProject\logo.jpg")
logo = Label(window, text = 'yes', image = photo1)

line = canvas1.create_line(320,0 , 320,200)
te = canvas1.create_text(700, 50, text="                   Goverment of India \n MINISTRY OF ROAD TRANSPORT & HIGHWAYS", fill="black", font=('Helvetica 15 bold'))
...
a = Label(canvas3 , text = 'Driving Licence No.*',bg = 'light gray', fg  = 'black' ,font=('Helvetica bold' , 13 , 'italic')).place(x = 300 , y = 70)
b = Label(canvas3, text = "Date Of Birth*" , bg = 'light gray', fg  = 'black', font=('Helvetica bold' , 13 , 'italic')).place(x = 300 , y = 130)
c = Label(canvas3, text = "Enter Verification Code*" , bg = 'light gray', fg  = 'black' ,font=('Helvetica bold' , 13 , 'italic')).place(x = 300 , y = 190)
dlentry= Entry(canvas3 ,width = 25, textvariable = 'largest font')
...
def reset():
    photo2 = PhotoImage(file=r"C:\Users\DELL\PycharmProjects\pythonProject\2.jpg")
    imggs = Label(window, image=photo2)
...
photo2 = PhotoImage(file = r"C:\Users\DELL\PycharmProjects\pythonProject\1.jpg")
imgg = Label(window, image = photo2)
...
longtext = Label(canvas5 , text = "Driving Licence number can be entered in any of the following formats: DL-1420110012345 or DL14 20110012345" ,fg = "red" ,bg = 'white',  font = ('italic', 10))
longtext1 = Label(canvas5 , text = "Total number of input characters should be exactly 16 (including space or '-')." , fg = "red" ,bg = 'white', font = ('italic', 10))
longtext2= Label(canvas5 , text = "If you hold an old driving license with a different format, please convert the format as per below rule before entering" , fg = "red" ,bg = 'white',font = ('italic', 10) )
longtext3= Label(canvas5 , text = "SS-RRYYYYNNNNNNN OR SSRR YYYYNNNNNNN" , fg = "red" ,bg = 'white', font = ('italic', 10))
longtext4= Label(canvas5 , text = "Where SS - Two character State Code (like RJ for Rajasthan, TN for Tamil Nadu etc)" ,fg = "red" ,bg = 'white', font = ('italic', 10) )
longtext5= Label(canvas5 , text = "RR - Two digit RTO Code" ,fg = "red" ,bg = 'white', font = ('italic', 10) )
longtext6= Label(canvas5 , text = "YYYY - 4-digit Year of Issue (For Example: If year is mentioned in 2 digits, say 99, then it should be converted to 1999. Similarly use 2012 for 12)" ,fg = "red" ,bg = 'white', font = ('italic', 10) )
longtext7= Label(canvas5 , text = "Rest of the numbers are to be given in 7 digits. If there are less number of digits, then additional 0's(zeros) may be added to make the total 7." ,fg = "red" ,bg = 'white', font = ('italic', 10) )
longtext8= Label(canvas5 , text = "For example: If the Driving Licence Number is RJ-13/DLC/12/ 123456 then please enter RJ-1320120123456 OR RJ13 20120123456" ,fg = "red" ,bg = 'white', font = ('italic', 10) )
